...
import styles from './SecondaryWebFooterStyles';
...
export default function WebFooterView(props) {
  ...
  return (
    ...
    >
            ...
            >
              <a href={'/'}>
                <img
                  ...
                  src={Images.logo_purple}
                  alt=""
                />
              </a>
              <p className={`mt-3 ${css(styles.logoCaptionPurple)}`}>
      ...
      <div className={`py-3 mt-4 ${css(styles.footerBottomPurple)}`}>
        <div className={`container ${css(styles.container)}`}>
