...
import SecondaryWebHeaderView from './SecondaryWebHeaderView';
import { isLoggedIn } from '../../../helpers/userHelper';
import { scrollToContactForm } from '../../../helpers/scrollToContactForm';

class SecondaryWebHeaderController extends React.Component {
  static propTypes = {
...
export default connect(
  mapStateToProps,
  actions
)(withTranslate(SecondaryWebHeaderController));
