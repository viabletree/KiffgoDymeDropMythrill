      ...
      >
        <div className={`row align-items-center ${css(styles.mt5)}`}>
          <div className="col-lg-6 col-md-12 col-sm-12 mt-3">
            ...
            >
              Route planning software for trucks
            </h2>
            ...
            >
              Route planning is only the tip of the iceberg and you need to stay
              on top of the game. Kiffgo is an all-in-one route optimization and
              scheduling. Smart route planning, real-time tracking of drivers,
              ePOD and customer communication.
            </p>
            <p
              className={`my-3 pr-5 ${css([
                AppStyles.heading16,
            ...
            >
              World class route planning engine for truck — built in
              collaboration with businesses, truck manufacturer, academics
              researchers and UX researchers capable of handling any real world
          ...
          <div className="col-lg-6 col-md-12 col-sm-12 mt-5">
            <img
              ...
              src={Images.truck_route_planner}
              alt={'Truck route planner'}
            />
          </div>
        </div>
      </div>
