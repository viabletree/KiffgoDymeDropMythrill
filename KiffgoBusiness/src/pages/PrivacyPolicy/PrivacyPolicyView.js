      ...
      <section>
        <div className={`px-5 ${css(AppStyles.container)}`}>
          ...
          <div className={`my-4 mb-5`}>
            ...
            <p className={`mb-3 ${css(AppStyles.pera18)}`}>
              Kiffgo driver app collects location data to enable the real-time
              delivery ETA calculation even when the app is closed or not in use
              while the driver is "on-duty." We do not access, collect, or store
              location information from a driver's mobile device when they are
              off-duty or offline.
            </p>
          </div>
