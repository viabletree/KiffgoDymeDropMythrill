...
export default function WebHeroSecView(props) {
  return (
    <section className={` ${css([styles.heroSection, AppStyles.pxy_12])}`}>
      ...
      >
        <div className={`row ${css(styles.mt5)}`}>
          <div className="col-lg-6 col-md-12 col-sm-12 mt-3">
            ...
            >
              Empower drivers and increase their productivity
            </h2>
            ...
            >
              Route planning is only the tip of the iceberg. Kiffgo driver app
              is an integral part of Kiffgo - routing and delivery management
              platform providing advanced route optimization, driver scheduling
              & dispatching and customer communication - All in one tool.
              <br />
              <br />
              Drivers love Kiffgo’s user-friendly mobile app because they can
              complete deliveries or tasks faster. The app works like a charm
              even in areas without internet.
            </p>
          ...
          <div
            className={`col-lg-6 col-md-12 col-sm-12 px-0 ${css(
              styles.headerGraphicsWrapper
            )}`}
          >
            <img
              alt="last-mile-delivery-app"
              className={css(styles.headerGraphics)}
              src={Images.driver_app_landing_page}
            />
          </div>
        </div>
      </div>
