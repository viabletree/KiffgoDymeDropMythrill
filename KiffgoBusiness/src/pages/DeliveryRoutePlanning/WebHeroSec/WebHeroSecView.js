      ...
      >
        <div className={`row ${css(styles.mt5)}`}>
          <div className="col-lg-6 col-md-12 col-sm-12 mt-3">
            ...
            >
              Delivery route planning for multiple stops, vehicle capacity,
              drivers and hubs
            </h2>
            ...
            >
              Improve your delivery operation with Kiffgo’s delivery route
              planning cloud-based software. Take into account Driver shift,
              Fleet capacity, Delivery time window, Traffic, and Roadworks.
              Optimize your delivery route planning and save time and money now!
            </p>
            ...
            <form>
              ...
              <div className={`form-row mb-2 ${css(styles.actionBtnWrapper)}`}>
                <div
                  className={`form-group col-md-4 ${css(
                    AppStyles.flexBox,
